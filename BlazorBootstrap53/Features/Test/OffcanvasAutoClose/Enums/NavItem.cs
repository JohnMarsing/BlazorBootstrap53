...
namespace BlazorBootstrap53.Features.Test.OffcanvasAutoClose.Enums;
...
public abstract class NavItem : SmartEnum<NavItem>
{
	...
	private sealed class PrimativeFamilyAltarSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.PrimativeFamilyAltar)} ";
	}
	...
	private sealed class EarliestTempleAltarSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.EarliestTempleAltar)} ";
	}
	...
	private sealed class SacredBoundaryLineSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.SacredBoundaryLine)} ";
	}
	...
	private sealed class OriginOfTheRiteSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.OriginOfTheRite)} ";
	}
	...
	private sealed class HebrewPassOverOrCrossOverSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.HebrewPassOverOrCrossOver)} ";
	}
	...
	private sealed class ChristianPassOverSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.ChristianPassOver)} ";
	}
	...
	private sealed class OutgrowthsAndPerversionsSE : NavItem
	{
		...
		//public override string Href => $"{Links.OffcanvasAutoClose.Index}/{nameof(Id.OutgrowthsAndPerversions)} ";
	}
